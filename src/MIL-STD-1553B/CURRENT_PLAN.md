...
- `MIL-STD-1553B.sln`�� `MilStd1553.Native`, `MilStd1553.Native.Tests` C++ ������Ʈ�� �߰��ߴ�.
- �ַ�� ��� ����Ƽ�� ���� ��δ� `C:\Program Files\Microsoft Visual Studio\2022\Professional\MSBuild\Current\Bin\MSBuild.exe .\MIL-STD-1553B.sln /t:Build /p:Configuration=Debug /p:Platform=x64`�� �����ߴ�.
- ���� ȸ�� ��� `powershell -NoProfile -ExecutionPolicy Bypass -File .\tests\native\run_tests.ps1`�� ��� 34�� ����ߴ�.
