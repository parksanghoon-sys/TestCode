...
- `docs/design/2026-04-20_�ַ��-native-project-�߰�_�������.md`�� �߰��ϰ� �ַ�ǿ� native project�� �����ϴ� �ּ� ���� ������ Ȯ���ߴ�.

### ����

- `src/native/MilStd1553.Native.vcxproj`, `tests/native/MilStd1553.Native.Tests.vcxproj`�� �߰��ߴ�.
- `MIL-STD-1553B.sln`�� `src/native`, `tests/native` ������ `Debug|x64`, `Release|x64` �ַ�� ������ �߰��ߴ�.
- VC++ project�� ���� ��ũ��Ʈ �� ���̸� ���̱� ���� `_SILENCE_CXX17_CODECVT_HEADER_DEPRECATION_WARNING` ��ó���� ���Ǹ� �ݿ��ߴ�.

### �׽�Ʈ �� ����

- `docs/test/2026-04-20_�ַ��-native-project-�߰�_�׽�Ʈ��ȹ.md`
- `docs/test/2026-04-20_�ַ��-native-project-�߰�_�׽�Ʈ���.md`
- `README.md`, `tests/native/README.md`, `CURRENT_PLAN.md`, `TODOS.md`�� ���� ���·� �����ߴ�.
